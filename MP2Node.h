...
public:
    ...
    bool nodeStatus(Address & address);
	void onCreate(Message & msg);
    void onRead(Message & msg);
    void onUpdate(Message & msg);
    void onDelete(Message & msg);
    void onUpdateReplyMsg(Message & msg);
    void onCreateReplyMsg(Message & msg);
    void onDeleteReplyMsg(Message & msg);
    void onReadReplyMsg(Message & msg);
	~MP2Node();
};
